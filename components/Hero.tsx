...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col items-center justify-start text-center h-screen w-screen px-6 sm:px-12 bg-gradient-to-br from-black via-zinc-900 to-gray-900">
      ...
      <p className="mt-6 max-w-xl text-zinc-400 text-sm sm:text-base">
